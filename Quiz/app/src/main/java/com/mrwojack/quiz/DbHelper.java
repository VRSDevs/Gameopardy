...
public class DbHelper extends SQLiteOpenHelper {
   ...
   private void fillQuestionsTable(){
        ...
        addQuestionM(M22);
        MultipleChoiceQuestions M23 = new MultipleChoiceQuestions("¿Cuales de estos juegos son considerados spin-offs de la saga Mario?","","","","","","","","sagas");
        addQuestionM(M23);
        MultipleChoiceQuestions M24 = new MultipleChoiceQuestions("¿Cuales de estos seres enemigos en la saga Metroid?","","","","","","","","sagas");
        addQuestionM(M24);
        MultipleChoiceQuestions M25 = new MultipleChoiceQuestions("¿En cuales de estos años ha salido un videojuego de plataformas 2D de Sonic? ","","","","","","","","sagas");
        addQuestionM(M25);
        MultipleChoiceQuestions M26 = new MultipleChoiceQuestions("La inteligencia artificial que ayuda a Master Chief en Halo se llama Alexa","","","","","","","","sagas");
        addQuestionM(M26);
        MultipleChoiceQuestions M27 = new MultipleChoiceQuestions("El primer Metal Gear salió en el año 1987","","","","","","","","sagas");
        addQuestionM(M27);
        MultipleChoiceQuestions M28 = new MultipleChoiceQuestions("El Red Dead Redemption 2 es una precuela de la primera entrega","","","","","","","","sagas");
        addQuestionM(M28);
        MultipleChoiceQuestions M29 = new MultipleChoiceQuestions("En la saga de videojuegos Super Smash Bros, Kirby puede copiar al menos una habilidad de todos los personajes","","","","","","","","sagas");
        addQuestionM(M29);
        MultipleChoiceQuestions M30 = new MultipleChoiceQuestions("¿Cual es el subtítulo del tercer juego de la saga Metal Gear Solid?","","","","","","","","sagas");
        addQuestionM(M30);
        MultipleChoiceQuestions M31 = new MultipleChoiceQuestions("De estos videojuegos, ¿cuales tienen una banda sonora compuesta por Koji Kondo?","","","","","","","","musica");
        addQuestionM(M31);
        MultipleChoiceQuestions M32 = new MultipleChoiceQuestions("¿A que videojuego pertenece esta canción?","","","","","","","","musica");
        addQuestionM(M32);
        MultipleChoiceQuestions M33 = new MultipleChoiceQuestions("¿A que videojuego pertenece esta canción?","","","","","","","","musica");
        addQuestionM(M33);
        MultipleChoiceQuestions M34 = new MultipleChoiceQuestions("¿De que videojuego es este tema musical?","","","","","","","","musica");
        addQuestionM(M34);
        MultipleChoiceQuestions M35 = new MultipleChoiceQuestions("¿De cuales de estas bandas sonoras se ha ocupado el compositor Shoji Meguro?","","","","","","","","musica");
        addQuestionM(M35);
        MultipleChoiceQuestions M36 = new MultipleChoiceQuestions("¿Cual de estos videojuegos se planteó originalmente como un videojuego infantil, pero acabó convertido en un juego de carácter irreverente para el publico adulto?","a","a","a","a","a","a","","curiosidades");
        addQuestionM(M36);
        MultipleChoiceQuestions M37 = new MultipleChoiceQuestions("¿Cual de estos videojuegos está protagonizado por una mujer?","","","","","","","","curiosidades");
        addQuestionM(M37);
        MultipleChoiceQuestions M38 = new MultipleChoiceQuestions("¿Cual de estos videojuegos NO está disponible en PlayStation 3?","","","","","","","","curiosidades");
        addQuestionM(M38);
        MultipleChoiceQuestions M39 = new MultipleChoiceQuestions("La última versión oficial de Minecraft es la 1.18","","","","","","","","curiosidades");
        addQuestionM(M39);
        MultipleChoiceQuestions M40 = new MultipleChoiceQuestions("¿Cual es la mítica frase que Toad le dice a Mario cuando supera el primer castillo en Super Mario Bros?","","","","","","","","curiosidades");
        addQuestionM(M40);
        MultipleChoiceQuestions M41 = new MultipleChoiceQuestions("¿Que quick-time event es famoso por el videojuego Call of Duty: Advanced Warfare? ","","","","","","","","curiosidades");
        addQuestionM(M41);
        MultipleChoiceQuestions M42 = new MultipleChoiceQuestions("¿A que videojuego pertenece este logo? ","","","","","","","","curiosidades");
        addQuestionM(M42);
        MultipleChoiceQuestions M43 = new MultipleChoiceQuestions("¿A que videojuego pertenece este zombi? (Imagen Zombi)","","","","","","","","curiosidades");
        addQuestionM(M43);
        ...
        addQuestionM(M49);
        MultipleChoiceQuestions M50 = new MultipleChoiceQuestions("¿Cual es la consola de SEGA con mayor número de ventas? ","","","","","","","","empresa");
        addQuestionM(M50);
    }
