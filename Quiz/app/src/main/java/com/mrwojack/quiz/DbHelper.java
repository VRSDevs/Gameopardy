...
public class DbHelper extends SQLiteOpenHelper {
   ...
   private void fillQuestionsTable(){
        ...
        addQuestionM(M31);
        MultipleChoiceQuestions M32 = new MultipleChoiceQuestions("¿A que videojuego pertenece esta canción?","Diddy Kong Racing","Crash Bandicoot","Super Mario 64","Sonic R","","","Diddy Kong Racing","sagas");
        addQuestionM(M32);
        MultipleChoiceQuestions M33 = new MultipleChoiceQuestions("¿A que videojuego pertenece esta canción?","Crash Team Racing","Gran Turismo 5","Sonic Adventure 2","Dragon Ball Z: Budokai 3","","","Sonic Adventure 2","sagas");
        addQuestionM(M33);
        MultipleChoiceQuestions M34 = new MultipleChoiceQuestions("¿De que videojuego es este tema musical?","Hades","Persona 5","Jet Set Radio","Shin Megami Tensei III: Nocturne","","","Persona 5","curiosidades");
        addQuestionM(M34);
        MultipleChoiceQuestions M35 = new MultipleChoiceQuestions("¿De cuales de estas bandas sonoras se ha ocupado el compositor Shoji Meguro?","Dragon Quest V","Final Fantasy VIII","Shin Megami Tense III: Nocturne","Persona 3","Persona 5","Chrono Trigger","Shin Megami Tense III: Nocturne, Persona 3, Persona 5","curiosidades");
        addQuestionM(M35);
        ...
        addQuestionM(M43);
        MultipleChoiceQuestions M44 = new MultipleChoiceQuestions("¿Que consola tiene el menor número de unidades vendidas?","Virtual Boy","Atari Lynx","PS Vita","Sega Dreamcast","","","Virtual Boy","historia");
        addQuestionM(M44);
        MultipleChoiceQuestions M45 = new MultipleChoiceQuestions("¿Cuantos bits tiene la arquitectura de la Nintendo GameCube?","16","32","64","128","","","128","historia");
        addQuestionM(M45);
        MultipleChoiceQuestions M46 = new MultipleChoiceQuestions("¿Que consolas han vendido menos de 15 millones de unidades?","Wii U","Sega Master System","Xbox","Sega Dreamcast","PlayStation Vita","Nintendo 64","Sega Dreamcast,Sega Master System,Sega Dreamcast","historia");
        addQuestionM(M46);
        MultipleChoiceQuestions M47 = new MultipleChoiceQuestions("¿Cual es el nombre de la consola que aparece en esta imagen?","Sega Saturn","NEO-GEO","Atari Jaguar","Sega Dreamcast","","","Atari Jaguar","historia");
        addQuestionM(M47);
        MultipleChoiceQuestions M48 = new MultipleChoiceQuestions("¿Cual de las siguientes consolas es la Sega Dreamcast? ","NEO-GEO","Nintendo 64","Sega Saturn","Sega Dreamcast","","","Sega Dreamcast","historia");
        addQuestionM(M48);
        MultipleChoiceQuestions M49 = new MultipleChoiceQuestions("¿Es la GameBoy Advanced una consola de 32 bits?","Verdadero","Falso","","","","","Verdadero","historia");
        addQuestionM(M49);
